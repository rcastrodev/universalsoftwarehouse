...
<h1>Detalle {{ $items->Numero_Caso }} <a href="{{ route('bitacora') }}" class="btn btn-sm btn-primary">Bitácora</a></h1>
@stop
@section('content')
				...
				<div class="col-sm-12">
					<div class="card card-primary">
						...
						<div class="card-body">
							...
							<textarea name="DescripcionSuModf1" id="DescripcionSuModf1" class="ckeditor" cols="30" rows="10" readonly>{{$items->DescripcionSuModf1}}</textarea>
							</div>
							<div class="form-group">
