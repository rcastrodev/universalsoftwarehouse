...
<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered" id="tabla_contabilidad">
        <thead>
            <tr>
...
<script>
    $('#tabla_contabilidad').DataTable({
        serverSide: false,
        ajax: `{{ config('app.url') }}/admin/contabilidad/get-list`,
        bSort: true,
        columns: [
